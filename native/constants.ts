...
export const MAX_COVER_CACHE_ENTRIES = 24;
export const COVER_REDIRECT_STATUSES = new Set([301, 302, 303, 307, 308]);

// The wire enum for Ynison-Device-Info is numeric even though the state object
// keeps the textual name: WEB is 1, WEB_TV is 5.
